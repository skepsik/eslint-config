...
const rulesSchema = z.custom((value) => typeof value === 'object' && value !== null && !Array.isArray(value), { message: 'must be a rules object' });
const typescriptOptionsShape = z
    ...
    .strict();
export const typescriptOptionsSchema = typescriptOptionsShape.refine((value) => Object.keys(value).length > 0, {
...
const createConfigOptionsSchema = z
    ...
    .strict();
export function parseCreateConfigOptions(options) {
