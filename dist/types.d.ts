...
import type { ProjectServiceOptions, TypeScriptOptionsInput, TypeScriptPreset } from './internal/create-config-schema.js';
...
export type TypeScriptContext = Record<TypeScriptPreset, (options?: TypeScriptScopeOptions) => FlatConfig>;
